...
export const useCartB2B = (user, editQuote, setEditQuote) => {
  


console.log('usss', user, 'quote', editQuote )
  ...
  useEffect(() => {
    if(editQuote?.id){
      setTotalPrice(editQuote?.subtotal)
      setTotalQuantities(editQuote?.quantity)
  ...
  const onAdd = (product, quantity, shopName, userId, shopId, ) => {
    ...
    // console.log('cartShop===',userId, shopId, )
