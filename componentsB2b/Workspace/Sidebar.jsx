...
const Sidebar = ({heading, onclick, list}) => {
  ...
  return (
    <div className="w-64 md:w-60 py-8 ">
        ...
        <div className="space-y-">
            {
                list?.map((item, index)=> {
                    ...
                    <div key={item.title}  className="  hover:bg-light100 duration-300">
                        { item.submenu ?
                        ...
                        >
                            ...
                            className={`w-full cursor-pointer px-10 py-3 rounded-l-full flex gap-2 bg-hover100 ${active=== item.title ? 'bg-light100 text' : null}  
                            relative`
                            }>
                        ...
                        <div 
                            ...
                            className={`w-full cursor-pointer px-10 py-3 rounded-l-full flex gap-2 bg-hover100 ${active=== item.title ? 'bg-light100 text-darkt300' : null}`  }>
                                <p className="text-2xl">{item.icon}</p>
                        ...
                        {item.submenu.map(({link, title, path}, subIndex) => (
                            ...
                            className={`py-3 pl-3 rounded-l-full w-full flex gap-2 items-center bg-hover100  ${active=== path ? 'bg-light100  text-dark300' : null} `}>
