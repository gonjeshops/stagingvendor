    ...
    <div className=' pb-20 px-4 space-y-8'>
        ...
        <div className="grid">
            <div className="grid mb-2 sm:mb-0 sm:flex justify-between gap-3 items-center w-full ">
                <DashboardHeading>Request details for #{content.quoteId}</DashboardHeading>
                
            </div>
            <h3 className='font-semibold text-3xl pb-2'></h3>

            <div className="grid gap-3 md:flex justify-between items-center ">
           
                <p className='text-lg'>Customer ID: <span className='text-blue-600 font-medium'>{content.customerId}</span></p>
