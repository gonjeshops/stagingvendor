...
import { resetData } from '../shared/Function';
	...
	const [formData, setFormData] = useState({
	  ...
	  const validateForm = (data) => {
		...
		if (!data.password.trim()) {
			...
			errors.password = '8+ characters, 1 upper, 1 lower, 1 number.';
		  }
	  ...
	  const handleSubmit = async (e) => {
		...
		setSuccessMessage('');
		setLoading(true);
		console.log('handlesubmit falseeeee')
